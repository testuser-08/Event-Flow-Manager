  ...
  return (
    <div className="flex-1 flex flex-col justify-center px-6 py-12">
      ...
      <div className="mb-10 text-center">
        ...
        <h1 className="text-3xl font-black uppercase tracking-tight text-foreground mb-1">Customer Support Summit</h1>
        <p className="text-muted-foreground font-mono text-xs uppercase tracking-widest">Summit Workstream Team</p>
      </div>
