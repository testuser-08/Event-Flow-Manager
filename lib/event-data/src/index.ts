...
export interface BreakoutTrack {
  ...
  name: string;
  location: string;
  color: string;       // Tailwind bg color class (web)
  textColor: string;   // Tailwind text color class (web)
  borderColor: string; // Tailwind border color class (web)
  hex: string;         // Hex color for React Native / inline styles
